...
class _MissionPageState extends State<MissionPage> {
  ...
  String selectedTime = '2:10 AM';
  final double s = 24;
  final branches = ['Amman (Taj Mall)', 'Amman (Abdali)', 'Irbid', 'Zarqa'];
  final times = ['2:10 AM', '1:55 PM', '5:35 PM', '10:00 PM'];

  @override
  void initState() {
    super.initState();
    _videoController = VideoPlayerController.asset('assets/videos/Mission.mp4')
      ..initialize().then((_) {
        setState(() {});
