...
class SikoPage extends StatefulWidget {
  const SikoPage({super.key});

  @override
  _SikoPageState createState() => _SikoPageState();
}

class _SikoPageState extends State<SikoPage> {
  late VideoPlayerController _videoController;
  DateTime selectedDate = DateTime.now();
  String selectedBranch = 'Amman (Taj Mall)';
  String selectedTime = '12:40 AM';
  final double s = 24;
  final branches = ['Amman (Taj Mall)', 'Amman (Abdali)', 'Irbid', 'Zarqa'];
  final times = ['12:40 AM', '12:30 PM', '6:20 PM', '7:45 PM'];

  @override
  void initState() {
    super.initState();
    _videoController = VideoPlayerController.asset('assets/videos/SIKO.mp4')
      ..initialize().then((_) {
        setState(() {});
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                  "Two cousins from a middle-class background inherit their uncle's estate, only to find it consists of illegal goods. To offload them, they create a mobile game called 'Siko Siko' to sell the goods. After a brief period of success, a mob boss shows up, claiming to be the true owner.",
